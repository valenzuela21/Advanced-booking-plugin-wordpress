...
(function($) {
    ...
    $.fn.dzscalendar = function(o) {
        ...
        this.each( function(){
            ...
            var arr_monthnames = object_calendar.month;
            var arr_weekdays = object_calendar.month_calendar;
...
//                    console.info(newurl);
                ...
                if(o.design_transitionDesc=='slide'){
                    ...
                    currDesc.html(cont);
                    currDesc.append('<div class="desc-close-button"><i class="close-modal-booking"></i></div>')
...
//                                console.log(date_y, date_m-1, date_d, curr_date, end_date, curr_date>=start_date, curr_date<=end_date);
                ...
                if(o.header_weekdayStyle=='three'){
                    for(i=0;i<arr_weekdays.length;i++){
                        var aux = arr_weekdays[i].substr(0,12);
                        weekDays[i] = aux;
                    }
                }
